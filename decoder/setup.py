...
videodecoder_module = Extension('videodecoder', ['video_decoder.cpp'], **options)

setup(name='videodecoder',
      version='0.1.0',
      description='Video decoder module.',
ext_modules=[videodecoder_module])